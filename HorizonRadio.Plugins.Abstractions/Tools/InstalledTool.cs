...
/// by the host's tool registry after a directory scan. Version is
...
/// sidecar and is null when no sidecar exists (older install, or upstream
/// sums file was missing at install time).
/// </summary>
